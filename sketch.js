...
var food;
var rabbit;
var empty_star,star_1,star2,starDisplay
...
function setup() 
{
  ...
  bl = createImg('baloon2.png')
  bl.position(295,370)
  bl.size(120,120)
  bl.mouseClicked(air_blow)
  ...
  starDisplay.addAnimation("one_star",star_1)
  starDisplay.addAnimation("two",star2)
  starDisplay.changeAnimation("empty",empty_star)
